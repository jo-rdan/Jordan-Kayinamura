      ...
      <>
        {products.length > 0 ? (
          products.map((product) => {
            return (
              <div
                className={`${size === "normal" ? "products" : "mini"}-cart`}
              >
                <div
                  className={`${
                    size === "normal" ? "product" : "mini"
                  }-details`}
                >
                  <div
                    className={`${
                      size === "normal" ? "products" : "mini"
                    }-title`}
                  >
                    {product.name}
                  </div>
                                  ...
                                  <>
                                    <div
                                      ...
                                      className={`${
                                        ...
                                        product.selectedArgs[attribute.name] ===
                                          item.value ||
                                        product.selectedArgs[index]?.[
                                          attribute.name
                                        ] === item.value
                                          ? "selected"
                                          : ""
                ...
                >
                  <div className="controls">
                    ...
                    <div
                      className="minus"
                      onClick={() =>
                        product.quantity > 1 && changeQuantity("-", product)
                      }
                    >
                      -
                    </div>
                  ...
                  <div
                    className={`${size === "normal" ? "product" : "mini"}-img`}
                  >
                    <SliderContent
                      active={
                      ...
                      content={product}
                    />
                    {size === "normal" && product.gallery.length > 1 ? (
                ...
                <div
                  className={`${size === "normal" ? "products" : "mini"}-close`}
